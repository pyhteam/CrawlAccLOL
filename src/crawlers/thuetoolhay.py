"""
ThueToolHay Crawler - Crawl dữ liệu từ thuetoolhay.com
"""
...
class ThueToolHayCrawler(BaseCrawler):
    """Crawler cho thuetoolhay.com"""

    @property
    def shop_name(self) -> str:
        return "thuetoolhay.com"

    @property
    def base_url(self) -> str:
        return "https://thuetoolhay.com/acc-rac-random-50k"

    def parse_page(self, html_content: str) -> List[Account]:
        """Parse HTML từ thuetoolhay.com"""
    ...
    def _extract_account(self, article) -> Account | None:
        ...
        try:
            ...
            info_section = article.find(
                "section", class_="text-sm info-line font-weight-bold"
            )
