...
class VnToolGameCrawler:
    def __init__(self):
        self.base_url = "https://vntoolgame.com/acc-rac-full-thong-tin"
        self.headers = {
    ...
    def extract_account_info(self, article):
        ...
        try:
            ...
            if link and not link.startswith('http'):
                link = f"https://vntoolgame.com{link}"
    ...
    def crawl_all_pages(self, max_pages=6):
        ...
        print(f"Sẽ crawl {max_pages} trang từ vntoolgame.com")
        ...
        if success_count == 0:
            print("⚠️  CẢNH BÁO: Không thể crawl được dữ liệu từ vntoolgame.com")
            print("   Có thể website đang bảo trì hoặc thay đổi cấu trúc")
            print("   Vui lòng thử lại sau hoặc chỉ sử dụng chothuesub.com")
